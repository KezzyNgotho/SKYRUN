...
export interface SkyRunTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface SkyRunToken extends BaseContract {
  connect(runner?: ContractRunner | null): SkyRunToken;
  waitForDeployment(): Promise<this>;

  interface: SkyRunTokenInterface;
