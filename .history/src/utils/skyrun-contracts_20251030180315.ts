export const SKYRUN_ADDRESSES = {
  token: "0x113336dDb74806699FD572EF32F716894F49C69A", // SDK-compatible deployment (address param)
  game: "0x1Ff365DdD369eCf9cE4F17643eF3102B3a8c42Bc",  // SDK-compatible deployment (address param)
...
export const SKYRUN_GAME_ABI = [
  ...
  // View Functions (SDK-compatible - takes address parameter)
  {
