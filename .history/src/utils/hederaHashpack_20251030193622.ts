...
async function mirrorNodeCallWithRetry(
  ...
  console.log(`🔍 Attempting Mirror Node call... (max ${maxRetries} attempts)`);
  ...
  for (let attempt = 0; attempt < maxRetries; attempt++) {
    try {
      ...
      if (response.ok) {
        console.log(`✅ Mirror Node responded successfully!`);
        return await response.json();
      }

      if (response.status === 404) {
        console.warn(`❌ Attempt ${attempt + 1} failed: Contract not indexed yet (404)`);
        ...
        if (attempt < maxRetries - 1) {
          ...
          console.error('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
          console.error('❌ ALL RETRIES FAILED - CONTRACT NOT INDEXED');
          console.error('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
          console.error('⏰ The contract exists but Mirror Node /call endpoint is not ready yet');
          console.error('⏰ This can take 15-30 minutes for new deployments');
          console.error('💡 Your transaction WAS successful! Just wait a bit longer.');
          console.error('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
          return null;
        }
      }
