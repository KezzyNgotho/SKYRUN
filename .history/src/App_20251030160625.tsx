...
const WalletBridge: React.FC = () => {
  ...
  const { submitScore, claimReward, buyLifeLine, getTokenBalance, getAvailableLives } = useSkyRunActions();
  ...
  }, [connected, accountId, connect, disconnect, submitScore, claimReward, buyLifeLine, getTokenBalance, getAvailableLives]);
