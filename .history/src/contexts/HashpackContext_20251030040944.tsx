  ...
  const value = useMemo<HashpackContextType>(() => {
    ...
    sendTransaction: async (txBytesOrTransaction: TransactionInput) => {
      ...
      try {
        ...
        try {
          console.log('Step 1: Setting TransactionId with fresh timestamp...');
          
          // CRITICAL: Set TransactionId as late as possible to minimize expiry time
          ...
          console.log('✅ Fresh TransactionId set');
          
          console.log('Step 2: Freezing transaction immediately...');
          const client = Client.forTestnet();
          const frozenTx = await transaction.freezeWith(client);
          console.log('✅ Transaction frozen');
          
          console.log('Step 3: Executing transaction with signer...');
          ...
          // Method 2: Try signer.call with frozen transaction
            ...
            console.log('✅ Transaction executed via signer.call!');
          }
