  ...
  const value = useMemo<HashpackContextType>(() => ({
    ...
    connect: async () => {
      ...
      try {
        ...
        // Just try to connect - HashConnect will handle extension detection internally
        ...
        if (error?.message?.includes('extension') || error?.message?.includes('No extension found')) {
          const shouldInstall = confirm(
            ...
            'Please install HashPack wallet extension to connect.\n\n' +
            'Click OK to open the HashPack download page.'
          );
          if (shouldInstall) {
