  ...
  useEffect(() => {
    ...
    const initHashConnect = async () => {
      try {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        const savedPairings = (hc as any).hcData?.pairingData || [];
        if (savedPairings.length > 0) {
          console.log('✅ Found existing pairing:', savedPairings[0]);
          // Trigger pairing event manually for existing connection
