  ...
  useEffect(() => {
    ...
    const initHashConnect = async () => {
      try {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        (window as any).checkWalletStatus = () => {
          console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
          ...
          if (window.reactWalletFunctions) {
            const walletStatus = window.reactWalletFunctions.getWalletStatus();
            console.log('📊 React Wallet Status:', walletStatus);
          }
          
          return { connected: !!pairingData, accountId: pairingData?.accountIds?.[0], status };
        };
        ...
        console.log('   To clear them: run clearWalletConnectData()');
        console.log('   Check wallet status: run checkWalletStatus()');
        console.log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
        console.log('');
      } catch (error) {
