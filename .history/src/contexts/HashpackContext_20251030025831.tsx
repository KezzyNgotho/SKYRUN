  ...
  const value = useMemo<HashpackContextType>(() => {
    ...
    sendTransaction: async (txBytes: Uint8Array) => {
      ...
      try {
        ...
        // Try different possible signer methods with proper error handling
        let result;
        let methodUsed = '';
        ...
        try {
          ...
          if (typeof signer.signAndExecuteTransaction === 'function') {
            ...
            throw new Error('Signer does not have any known transaction method. The signer object may be invalid.');
          }
          ...
          // Return success regardless of result format
