  ...
  const value = useMemo<HashpackContextType>(() => {
    ...
    sendTransaction: async (txBytesOrTransaction: TransactionInput) => {
      ...
      try {
        ...
        try {
          console.log('Step 1: Using signer.call() with UNFROZEN transaction...');
          console.log('This allows HashConnect to freeze at approval time, avoiding expiry');
          
          // Try signer.call with UNFROZEN transaction
          // This should prompt HashPack and let it handle freezing/signing/execution
