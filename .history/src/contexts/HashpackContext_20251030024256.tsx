  ...
  useEffect(() => {
    ...
    const initHashConnect = async () => {
      try {
        ...
        // Clear old/expired WalletConnect sessions
        // The "No matching key" errors are from expired sessions - clearing them prevents issues
        try {
          ...
          if (keysToCheck.length > 0) {
            console.log('🧹 Clearing', keysToCheck.length, 'old WalletConnect session(s)...');
            ...
            console.log('✅ Old sessions cleared - will create fresh connection');
          }
        } catch (e) {
