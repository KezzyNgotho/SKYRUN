...
window.addEventListener('DOMContentLoaded', function() {
  ...
  // Provide contract call functions for game.js (Hedera versions)
  window.callHederaFinalize = async function(fnArgs) {
    console.log('🎯 === callHederaFinalize CALLED ===');
    ...
    if (window.reactWalletFunctions && window.reactWalletFunctions.submitGameScore) {
      try {
        ...
        console.log('🎮 Submitting score to Hedera blockchain:', score, '(from raw:', rawScore, ')');
