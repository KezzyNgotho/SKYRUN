...
window.addEventListener('DOMContentLoaded', function() {
  ...
  window.syncBlockchainStats = async function() {
    ...
    try {
      ...
      // Update GAMES PLAYED (if there's a UI element for it)
      const gamesPlayedElements = document.querySelectorAll('.gamesPlayedValue, #gamesPlayed, [data-stat="games-played"]');
